...
from model_file.CNN import eeg_cnn
from model_file.Resnet import resnet34_rearrange, resnet50_rearrange, resnet101_rearrange
...
from process_data import process_BCICIII_data_set_IVa
...
def train(seed, flag):
    ...
    tra_nums = {'a': 168, 'l': 224}
    mat_file_path = './data_set/BCICIII/data_set_IVa/100Hz/data_set_IVa_a{0}.mat'.format(subject)

    mat_file = loadmat(mat_file_path)

    X, Y = process_BCICIII_data_set_IVa(mat_file, low_frequency_limit=8, high_frequency_limit=30,
                                        tra_nums=tra_nums[subject], random_seed=seed)
